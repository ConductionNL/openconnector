...
class RuleService
{
    ...
    private function processSoftwareCatalogusRule(Rule $rule, array $data): array
    {
        ...
        foreach ($this->createdRelationIds as $relationId) {
            $data['body']['organizations'][$relationsFolderKey]['item'][$relationsFolderCount]['item'][] = ['identifierRef' => $relationId];
        }
    ...
    private function processVoorzieningenData(
        ...
        foreach ($voorzieningen as $voorziening) {
            ...
            $data['body']['organizations'][$applicationFolderKey]['item'][$applicationFolderCount]['item'][] = ['identifierRef' => $elementId];
