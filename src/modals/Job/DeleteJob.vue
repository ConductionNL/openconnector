...
<template>
	<NcDialog v-if="navigationStore.dialog === 'deleteJob'"
		:name="t('openconnector', 'Delete job')"
		size="normal"
		:can-close="false">
		<p v-if="!success">
			{{ t('openconnector', 'Do you want to delete') }} <b>{{ jobStore.jobItem.name }}</b>? {{ t('openconnector', 'This action cannot be undone.') }}
		</p>

		<NcNoteCard v-if="success" type="success">
			<p>{{ t('openconnector', 'Successfully deleted job') }}</p>
		</NcNoteCard>
